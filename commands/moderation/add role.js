...
run: async (bot, message, args) => {
        ...
        if (!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send("**You Dont Have The Permissions To Add Roles To Users! - [MANAGE_ROLES]**<:recluse5:827723090125258812> ");
        ...
        if (!args[0]) return message.channel.send("**Please Enter A Role!**<:recluse5:827723090125258812> ")
        ...
        if (!role) return message.channel.send("**Could Not Find That Role!**<:recluse2:827723090125258812> ")
